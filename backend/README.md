...
## Project Structure
    ...
    ├── bakers_remodeling_32876  # Django project configurations
...
1. Clone this repo and `cd bakers_remodeling_32876`
...
2. Clone this repo and `cd bakers_remodeling_32876`
